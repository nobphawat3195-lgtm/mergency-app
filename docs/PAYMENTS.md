...
4. แอดมินเปิดแอปธนาคารตรวจว่ายอดเข้าจริง แล้วกด:
   - **ยอดเข้าแล้ว**: สถานะเป็น `PAID` และส่วนของช่างเข้ากระเป๋า กดซ้ำได้ ไม่เครดิตซ้ำ
...
เมื่อช่างกด "ยืนยันว่าได้รับเงินสดแล้ว" เงินทั้งหมดอยู่กับช่าง ระบบจึงหักค่าบริการแพลตฟอร์ม (`COMMISSION_RATE`) จากกระเป๋าช่าง
